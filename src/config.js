...
export const PROJECTS = [
  ...
  },
  {
    ...
    image:  'projects/game-sync-server.webp',
    imageAlt: '중앙의 빛나는 코어와 네 플레이어 캐릭터 플랫폼이 연결된 동기화 개념 이미지',
    imageCaption: 'AI 생성 예시 이미지',
  ...
  },
  {
    ...
    image:  'projects/dev-admin-dashboard.webp',
    imageAlt: '청록색 선그래프와 주황색 막대그래프, 활동 목록으로 구성한 관리자 대시보드 목업',
    imageCaption: 'AI 생성 예시 이미지',
  ...
  },
  {
    ...
    image:  'projects/casual-puzzle.webp',
    imageAlt: '민트색과 살구색, 라일락색 블록으로 구성한 캐주얼 퍼즐 보드',
    imageCaption: 'AI 생성 예시 이미지',
    github: null,
  ...
  },
  {
    ...
    image:  'projects/ai-npc-dialogue.webp',
    imageAlt: '등불이 켜진 판타지 상점에서 상인과 여행자가 대화하는 장면',
    imageCaption: 'AI 생성 예시 이미지',
  ...
  },
  {
    ...
    image:  'projects/shader-playground.webp',
    imageAlt: '유리 구체와 반사 금속 구체, 무지갯빛 토러스의 재질 렌더링 장면',
    imageCaption: 'AI 생성 예시 이미지',
